    ...
    public class JogoViewModel : INotifyPropertyChanged
    {
        ...
        private void MostrarPalavraAction()
        {
            ...
            if (NumNivel == 0)
            {
                ...
                int niv = rd.Next(0, 2);
                int ind = rd.Next(0, Armazenamento.Armazenamento.Palvras[niv].Length);
                Palavra = Armazenamento.Armazenamento.Palvras[niv][ind];
            ...
            if (NumNivel == 1)
            {
                //Fac.
                Random rd = new Random();
                int ind = rd.Next(0, Armazenamento.Armazenamento.Palvras[NumNivel - 1].Length);
                Palavra = Armazenamento.Armazenamento.Palvras[NumNivel - 1][ind];
                PalavraPontuacao = 1;
            }
